// 전체 학생 데이터
const students = [
    { id: "이동훈1", password: "1111", score: 85, grade: "-등급",
      message1: "우수한 성적입니다! 조금만 더 노력해 봅시다.", 
      message2: "성적역사 - Na", 
      downloadLink: "?" },

    { id: "김가연1", password: "8888", score: 92, grade: "-등급",
    ...
    { id: "신가영1", password: "7777", score: 78, grade: "-등급",
      message1: "꾸준한 연습이 필요합니다! 다음 시험을 대비해보세요.", 
      message2: "성적역사 - Na", 
      downloadLink: "?" },

    { id: "홍나연1", password: "2222", score: 88, grade: "-등급",
    ...
    { id: "홍수민1", password: "3333", score: 81, grade: "-등급",
    ...
    { id: "박세준2", password: "1010", score: 74, grade: "-등급",
      message1: "지금도 좋지만, 한 단계 더 도약할 수 있어요!", 
      message2: "성적역사 - Na", 
      downloadLink: "Non-specific-link" },

    { id: "구재모2", password: "1212", score: 69, grade: "-등급",
    ...
    { id: "신비2", password: "4545", score: 95, grade: "-등급",
      message1: "완벽한 성적! 대단해요!", 
      message2: "성적역사 - Na", 
      downloadLink: "?" },

    { id: "박범서2", password: "7070", score: 90, grade: "-등급",
      message1: "아주 좋은 성적이에요!", 
      message2: "성적역사 - Na", 
      downloadLink: "?" },

    { id: "오지훈2", password: "8383", score: 77, grade: "-등급",
    ...
    { id: "이서진2", password: "9696", score: 84, grade: "-등급",
      message1: "꾸준한 노력이 보이는 성적이에요!", 
      message2: "성적역사 - Na", 
      downloadLink: "?" },

    { id: "한태혁2", password: "2929", score: 71, grade: "-등급",
